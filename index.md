...
and `false` otherwise, so let's use that in our `if` statement:
...
```
[Sourcecode on Github](https://raw.githubusercontent.com/LukeStorry/code-a-clock/master/example_code/simple_clock.pde)
